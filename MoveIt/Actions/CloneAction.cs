...
;
            ...
            foreach (var state in m_states)
            {
                ...
                {
                    MoveItTool.TMPE.Paste(nodeState.TMPE_NodeRecord, m_InstanceID_origToClone);
                }
                else if (state is SegmentState segmentState)
                {
                    MoveItTool.TMPE.Paste(segmentState.TMPE_SegmentRecord, m_InstanceID_origToClone);
                    MoveItTool.TMPE.Paste(segmentState.TMPE_SegmentStartRecord, m_InstanceID_origToClone);
                    MoveItTool.TMPE.Paste(segmentState.TMPE_SegmentEndRecord, m_InstanceID_origToClone);
                }
            }
